...
public class loginw extends AppCompatActivity {
    EditText email,pass;
    Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loginw);
        email=(EditText)findViewById(R.id.emailu);
        pass=(EditText)findViewById(R.id.passwordu);
        bt=(Button)findViewById(R.id.loginu);
        tx=(TextView)findViewById(R.id.Dontu);
        t=findViewById(R.id.e5);
        pr=(ProgressBar)findViewById(R.id.pBar);
        fauth=FirebaseAuth.getInstance();
        txt1=(TextView)findViewById(R.id.manageru);
                ...
                fauth.signInWithEmailAndPassword(memail,mpass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(loginw.this,"login  is not  successful",Toast.LENGTH_LONG).show();
                    }
                });
        ...
        tx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),signupu.class));
            }
        });
